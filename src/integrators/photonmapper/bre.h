...
public:
   ...
   */
  BeamRadianceEstimator(const PhotonMap *pmap, size_t lookupSize, Float scaleVol = 1.f, bool cameraHeuristic = false);
  ...
  Spectrum query(const Ray &ray, const Medium *medium, int depth,
                 bool use3Dkernel = false, Sampler *sampler = 0) const;
